...
import cn.cnic.instdb.ftp.minimalftp.api.CommandInfo;
import cn.cnic.instdb.ftp.minimalftp.api.IFileSystem;
import cn.cnic.instdb.ftp.minimalftp.api.ResponseException;
import cn.cnic.instdb.ftp.minimalftp.handler.ConnectionHandler;
import cn.cnic.instdb.ftp.minimalftp.handler.FileHandler;
...
public class FTPConnection implements Closeable {
    ...
    //ftprole role  role"" role role  role role_general  role role
    public void setRole(String role) {
        conHandler.setRole(role);
    }

    //This represents a user with restricted access ftpThis represents a user with restricted access
    public void setRealUsers(String realUsers) {
        conHandler.setRealUsers(realUsers);
    }

    public void setResourceId(String resourceId) {
        conHandler.setResourceId(resourceId);
    }

    //This is used to pass in custom implementation classes
    public void setControl(FtpCustomization control) {
        conHandler.setControl(control);
    }
    ...
    public String getRole() {
        return conHandler.getRole();
    }

    public String getRealUsers() {
        return conHandler.getRealUsers();
    }

    public String getResourceId() {
        return conHandler.getResourceId();
    }

    public FtpCustomization getControl() {
        return conHandler.getControl();
    }
