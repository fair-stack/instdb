...
/**
 * SMS4National Secret Algorithm
 */

@Slf4j
public class SMS4 {
    private static byte[] key = "instdb".getBytes();
    ...
    /**
     * Unlimited plaintext lengthSMS4Unlimited plaintext length
     *
     * @param plaintext
     * @param key
     * @return
    ...
    private void SMS4KeyExt(byte[] Key, int[] rk, int CryptFlag) {
        ...
        // Decryption Wheel Key Usage Order：rk31,rk30,...,rk0
    ...
    /**
     * The encrypted string isSMS4The encrypted string is
     *
     * @param encodingStr
     * @return
     */
